        ...
        .config(function ($stateProvider, $urlRouterProvider) {
            $stateProvider
                ...
                .state('module.default.module1', {  
                    ...
                    views: {
                        'content@module': {
                            templateUrl: 'modules/module-1/index.html',
                            controller: 'Module1Ctrl'
                        }
                    },
                    resolve: {
                        loadModule: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('modules/module-1/index.js');
                        }]
                    }
                })
                .state('module.default.module1.customer-view', {
                    url: '/customer-view',
                    templateUrl: 'modules/module-1/customer-view/index.html',
                    controller: 'Module1CustomerViewCtrl',
                    data: {
                        ensureJsdos: ["CustomerService","SalesrepService"]
                    },
                    resolve: {
                        onInit: ['$injector', '$stateParams', function($injector, $stateParams) {
                            return $injector.get('module1CustomerView')['onInit']($stateParams);
                        }]
                    },
                    onExit: ['$injector', 'onInit', function($injector, onInit) {
                        $injector.get('module1CustomerView')['onHide'](onInit);
                    }]
                });
