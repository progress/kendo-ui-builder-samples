...
//					console.log("CustomerModel: " + this.scope._$viewModels.CustomerDSModel.uid + " " + this.scope._$viewModels.CustomerDSModel.CustNum + " " + this.scope._$viewModels.CustomerDSModel.Name);
				...
				saveCustomer: function () {
					var customerDS = this.scope._$ds.CustomerDS,
                        dataItem = customerDS.getByUid(this.scope._$viewModels.CustomerDSModel.uid),
                        fields = customerDS.transport.jsdo.getSchema();

					console.log("DEBUG: save: ");
					console.log("CustomerModel: " + this.scope._$viewModels.CustomerDSModel.uid + " " +
                                this.scope._$viewModels.CustomerDSModel.CustNum + " " + this.scope._$viewModels.CustomerDSModel.Name);
					...
					this.scope._$viewModels.CustomerDSModel.SalesRep = angular.element("#salesreps").data("kendoComboBox").value();
					this.scope._$viewModels.CustomerDSModel.Country = angular.element("#country").data("kendoDropDownList").value();
					...
					for (var i = 0; i < fields.length; i += 1) {
						...
						dataItem.set(fields[i].name, this.scope._$viewModels.CustomerDSModel[fields[i].name]);
					}
					*/
				...
				createCountryDropDownList: function () {
				...
				displaySalesrep: function (customerModel) {
				...
				displayCountry: function (customerModel) {
