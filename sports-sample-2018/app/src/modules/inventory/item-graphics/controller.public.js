...
class InventoryItemGraphicsCtrl extends BaseController {
...
InventoryItemGraphicsCtrl.$inject = ['$scope', '$injector', 'stateData'];

export default InventoryItemGraphicsCtrl