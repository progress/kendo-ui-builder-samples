        ...
        .config(function ($stateProvider, $urlRouterProvider) {
            $stateProvider
                ...
                .state('module.default.customers', {  
                    ...
                    views: {
                        'content@module': {
                            templateUrl: 'modules/customers/index.html',
                            controller: 'CustomersCtrl'
                        }
                    },
                    resolve: {
                        loadModule: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('modules/customers/index.js');
                        }]
                    }
                })
                .state('module.default.customers.customer-dg', {
                    url: '/customer-dg',
                    templateUrl: 'modules/customers/customer-dg/index.html',
                    ...
                    resolve: {
                        onInit: ['$injector', '$stateParams', function($injector, $stateParams) {
                            return $injector.get('customersCustomerDg')['onInit']($stateParams);
                        }]
                    },
                    onExit: ['$injector', 'onInit', function($injector, onInit) {
                        $injector.get('customersCustomerDg')['onHide'](onInit);
                    }]
                });
