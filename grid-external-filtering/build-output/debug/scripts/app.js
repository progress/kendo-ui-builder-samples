        ...
        .config(function ($stateProvider, $urlRouterProvider) {
            $stateProvider
                ...
                .state('module.default.gridExternalFiltering', {  
                    ...
                    views: {
                        'content@module': {
                            templateUrl: 'modules/grid-external-filtering/index.html',
                            controller: 'GridExternalFilteringCtrl'
                        }
                    },
                    resolve: {
                        loadModule: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('modules/grid-external-filtering/index.js');
                        }]
                    }
                })
                .state('module.default.gridExternalFiltering.grid-external-filtering', {
                    url: '/grid-external-filtering',
                    templateUrl: 'modules/grid-external-filtering/grid-external-filtering/index.html',
                    controller: 'GridExternalFilteringGridExternalFilteringCtrl',
                    data: {
                        ensureJsdos: ["CustomerService"]
                    },
                    resolve: {
                        onInit: ['$injector', '$stateParams', function($injector, $stateParams) {
                            return $injector.get('gridExternalFilteringGridExternalFiltering')['onInit']($stateParams);
                        }]
                    },
                    onExit: ['$injector', 'onInit', function($injector, onInit) {
                        $injector.get('gridExternalFilteringGridExternalFiltering')['onHide'](onInit);
                    }]
                });
