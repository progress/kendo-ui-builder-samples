...
@multiselect-buttons-background: lighten(@hover-background, 4%);
@multiselect-buttons-border-color: lighten(@hover-background, 4%);
@multiselect-buttons-hover-background: @hover-background;
@multiselect-buttons-hover-border-color: @hover-background;
...
@primary-button-background-color: lighten(@accent, 9%);
@primary-button-border-color: lighten(@accent, 4%);
