                ...
                .state('module.default.employees', {  
                    ...
                    resolve: {
                        loadModule: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('modules/employees/index.js');
                        }]
                    }
                })
                .state('module.default.employees.employee-view', {
                    url: '/employee-view',
                    templateUrl: 'modules/employees/employee-view/index.html',
                    controller: 'EmployeesEmployeeViewCtrl',
                    data: {
                        ensureJsdos: ["EmployeeService"]
                    },
                    resolve: {
                        onInit: ['$injector', '$stateParams', function($injector, $stateParams) {
                            return $injector.get('employeesEmployeeView')['onInit']($stateParams);
                        }]
                    },
                    onExit: ['$injector', 'onInit', function($injector, onInit) {
                        $injector.get('employeesEmployeeView')['onHide'](onInit);
                    }]
                });
