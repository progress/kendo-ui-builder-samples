...
.km-ios .km-switch-handle {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, from(#ffffff), color-stop(5%, #d7d7d7), color-stop(5%, #ffffff));
...
.km-ios .k-slider-track {
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.3)), color-stop(30%, rgba(0, 0, 0, 0)), color-stop(90%, rgba(0, 0, 0, 0)), color-stop(90%, rgba(0, 0, 0, 0.4)), color-stop(bottom, to), color-stop(bottom, #dbdbdb), color-stop(bottom, #ffffff));
