...
.k-multiselect li.k-button.k-state-active,
...
.k-multiselect li.k-state-focused,
.k-multiselect li:focus {
...
.k-button.k-primary.k-flat.k-state-active,
.k-button.k-primary.k-flat:active,
...
.k-icon.k-i-loading {
  ...
  -webkit-box-shadow: inset 0 0 0 2px #ff6358;
          box-shadow: inset 0 0 0 2px #ff6358;
  border-radius: 50%;
...
.k-i-loading:before {
  ...
  -webkit-animation: k-loading-animation 2s infinite ease 1.5s;
  animation: k-loading-animation 2s infinite ease 1.5s;
}
.k-i-loading:after {
  ...
  -webkit-animation: k-loading-animation 2s infinite ease;
  animation: k-loading-animation 2s infinite ease;
}
...
.k-autocomplete.k-state-focused .k-clear-value:hover,
.k-autocomplete.k-state-hover .k-clear-value:hover,
.k-autocomplete:hover .k-clear-value:hover,
...
.k-numerictextbox .k-link {
  display: block;
  padding: 0 4px;
  height: -webkit-calc(4px + 0.71428571em);
  height: calc(4px + 0.71428571em);
  overflow: hidden;
}
...
.k-list-filter {
  ...
  position: relative;
  padding: 8px;
  height: -webkit-calc(24px + 1.42857143em);
  height: calc(24px + 1.42857143em);
  -webkit-box-sizing: border-box;
          box-sizing: border-box;
}
...
.k-button.k-bare.k-state-hover:before,
.k-button.k-bare:hover:before {
  opacity: .07;
  z-index: auto;
}
...
.k-button.k-bare.k-state-active:before,
.k-button.k-bare:active:before {
  opacity: 0.08;
}
.k-button.k-bare.k-state-active:after,
.k-button.k-bare:active:after {
  opacity: 0.13;
}
.k-button.k-bare.k-state-active:after,
.k-button.k-bare.k-state-active:before,
...
.k-button.k-flat.k-state-focused,
...
.k-button.k-primary.k-flat.k-state-focused,
.k-button.k-primary.k-flat:focus {
  -webkit-box-shadow: 0 3px 4px 0 rgba(255, 99, 88, 0.4);
          box-shadow: 0 3px 4px 0 rgba(255, 99, 88, 0.4);
}
.k-button.k-outline {
...
.k-dialog-buttongroup .k-button.k-primary:hover.k-state-focused,
.k-dialog-buttongroup .k-button.k-primary:hover:focus {
  -webkit-box-shadow: inset 0 0 0 2px rgba(0, 0, 0, 0.1);
          box-shadow: inset 0 0 0 2px rgba(0, 0, 0, 0.1);
}
.k-dialog-buttongroup .k-button.k-primary.k-state-active,
...
.k-filtercell > span {
  padding-right: -webkit-calc(2 * (1.42857143em + 8px + 2px + 4px));
  padding-right: calc(2 * (1.42857143em + 8px + 2px + 4px));
  display: block;
  position: relative;
}
...
.k-filtercell > .k-operator-hidden {
  padding-right: -webkit-calc(1.42857143em + 8px + 2px + 4px);
  padding-right: calc(1.42857143em + 8px + 2px + 4px);
}
...
.k-filtercell .k-dropdown-operator {
  ...
  position: absolute;
  top: 0;
  right: -webkit-calc(1.42857143em + 8px + 2px + 4px);
  right: calc(1.42857143em + 8px + 2px + 4px);
}
...
.k-toolbar .k-overflow-anchor {
  padding: 8px;
  width: -webkit-calc(1.42857143em + 8px + 2px + 16px);
  width: calc(1.42857143em + 8px + 2px + 16px);
  height: -webkit-calc(1.42857143em + 8px + 2px + 16px);
  height: calc(1.42857143em + 8px + 2px + 16px);
  border-width: 0 0 0 1px;
  border-color: inherit;
  -webkit-background-clip: padding-box;
          background-clip: padding-box;
...
.k-toolbar .k-split-button .k-button:after,
.k-toolbar .k-split-button .k-button:before {
  display: none;
}
...
.k-spreadsheet-selection {
  border-color: #ff6358;
  background-color: rgba(255, 99, 88, 0.25);
  -webkit-box-shadow: inset 0 0 0 1px #fff, 0 0 0 1px #ff6358;
          box-shadow: inset 0 0 0 1px #fff, 0 0 0 1px #ff6358;
}
.k-spreadsheet .k-filter-range {
  border-color: #ff6358;
}
...
.k-compact .k-datetimepicker .k-link,
.k-datetimepicker.k-compact .k-link {
  padding: 2px;
}
.k-dateinput {
  position: relative;
...
.k-compact .k-dateinput .k-link,
.k-dateinput.k-compact .k-link {
  padding: 0 2px;
}
.k-datepicker .k-select,
.k-datetimepicker .k-select,
...
.k-radio:checked + .k-radio-label:before {
  background-color: #ff6358;
  border-color: transparent;
  -webkit-box-shadow: inset 0 0 1px 0 #ff6358;
          box-shadow: inset 0 0 1px 0 #ff6358;
}
.k-radio:checked + .k-radio-label:after {
  background-color: #fff;
}
...
.k-multiselect li.k-state-focused .k-icon,
.k-multiselect li:focus .k-icon {
  opacity: 1;
}
...
.k-compact .k-numerictextbox .k-link,
.k-numerictextbox.k-compact .k-link {
  padding: 0 2px;
}
...
.k-upload .k-multiple-files-invalid-extension-wrapper:before {
  background-color: #fff;
  border-color: transparent transparent #fcd0cb #fcd0cb;
}
...
.k-upload .k-multiple-files-invalid-extension-wrapper:after {
  border-top-color: #fcd0cb;
  border-left-color: #fcd0cb;
}
...
.k-calendar-navigation .k-content > ul > li {
  height: 2em;
  line-height: 2em;
  cursor: pointer;
  padding-right: 100px;
...
.k-calendar .k-state-selected.k-state-focused .k-link {
  -webkit-box-shadow: inset 0 0 0 2px #ff594e;
...
.k-menu .k-link .k-i-arrow-60-down,
.k-menu .k-link .k-i-arrow-s:before,
.k-menu .k-link .k-i-collapse:before,
.k-menu .k-link .k-i-expand-s:before,
.k-menu .k-link .k-i-sarrow-s:before {
  margin-left: 4px;
  margin-right: -4px;
}
