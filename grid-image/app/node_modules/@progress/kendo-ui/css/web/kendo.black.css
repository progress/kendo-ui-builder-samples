...
.k-task-complete {
  border-color: #75baff;
  background: #2994ff 0 -257px url('textures/highlight.png') repeat-x;
  color: #fff;
}
.k-event-inverse {
  color: #333333;
...
.k-button:focus:not(.k-state-disabled):not([disabled]) {
  -webkit-box-shadow: inset 0 0 3px 1px #2a2a2a;
          box-shadow: inset 0 0 3px 1px #2a2a2a;
}
...
.k-split-button:focus {
  -webkit-box-shadow: inset 0 0 4px 2px #2a2a2a;
          box-shadow: inset 0 0 4px 2px #2a2a2a;
}
...
/* Map */
.k-map .k-marker {
  background-image: url("Black/markers.png");
}
@media only screen and (-webkit-min-device-pixel-ratio: 1.2), only screen and (min-device-pixel-ratio: 1.2) {
  .k-map .k-marker {
    background-image: url("Black/markers_2x.png");
  }
}
.k-map .k-attribution {
  color: #666666;
...
.k-spreadsheet-selection {
  border-color: #0066cc;
  -webkit-box-shadow: inset 0 0 0 1px #4d4d4d, 0 0 0 1px #0066cc;
          box-shadow: inset 0 0 0 1px #4d4d4d, 0 0 0 1px #0066cc;
}
.k-spreadsheet-selection {
  background-color: rgba(0, 102, 204, 0.2);
}
