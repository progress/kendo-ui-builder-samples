...
.k-task-complete {
  border-color: #fee3a1;
  background: #fdcd56 0 -257px url('textures/highlight.png') repeat-x;
  color: #2d3b4f;
}
.k-event-inverse {
  color: #2a2d34;
...
.k-button:focus:not(.k-state-disabled):not([disabled]) {
  -webkit-box-shadow: inset 0 0 3px 1px #232d36;
          box-shadow: inset 0 0 3px 1px #232d36;
}
...
.k-widget.k-notification {
  background-image: url("textures/brushed-metal.png");
  background-image: url("textures/brushed-metal.png"), -webkit-gradient(linear, left top, left bottom, from(rgba(255,255,255,.25)), to(rgba(255,255,255,0)));
  background-image: url("textures/brushed-metal.png"), -webkit-linear-gradient(top, rgba(255,255,255,.25) 0%, rgba(255,255,255,0) 100%);
...
.k-split-button:focus {
  -webkit-box-shadow: inset 0 0 4px 2px #232d36;
          box-shadow: inset 0 0 4px 2px #232d36;
}
...
.k-spreadsheet-selection {
  border-color: #f4af03;
  -webkit-box-shadow: inset 0 0 0 1px #414550, 0 0 0 1px #f4af03;
          box-shadow: inset 0 0 0 1px #414550, 0 0 0 1px #f4af03;
}
.k-spreadsheet-selection {
  background-color: rgba(244, 175, 3, 0.2);
}
.k-spreadsheet-active-cell {
  border-color: #f4af03 !important;
  background-color: #414550;
}
