(function(angular) {
    ...
    /**
     * @ngdoc overview
     * @name list-view-crud-with-validation
     * @description
     * #
     *
        ...
        .config(function ($stateProvider, $urlRouterProvider) {
            $stateProvider
                ...
                .state('module.default.customerCrud', {  
                    ...
                    views: {
                        'content@module': {
                            templateUrl: 'modules/customer-crud/index.html',
                            controller: 'CustomerCRUDCtrl'
                        }
                    },
                    resolve: {
                        loadModule: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load('modules/customer-crud/index.js');
                        }]
                    }
                })
                .state('module.default.customerCrud.list-view-external-form', {
                    url: '/list-view-external-form',
                    templateUrl: 'modules/customer-crud/list-view-external-form/index.html',
                    controller: 'CustomerCRUDListViewExternalFormCtrl',
                    data: {
                        ensureJsdos: ["Customers"]
                    },
                    resolve: {
                        onInit: ['$injector', '$stateParams', function($injector, $stateParams) {
                            return $injector.get('customerCrudListViewExternalForm')['onInit']($stateParams);
                        }]
                    },
                    onExit: ['$injector', 'onInit', function($injector, onInit) {
                        $injector.get('customerCrudListViewExternalForm')['onHide'](onInit);
                    }]
                });
